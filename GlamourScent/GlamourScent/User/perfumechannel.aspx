<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="perfumechannel.aspx.cs" Inherits="GlamourScent.User.chanel" %>
          ...
          <div class="col-md-6 prodetail caption product-thumb">
            ...
            <div id="product">
              ...
              <div class="button-group mt_30">
                  <asp:Button ID="Button1" runat="server" Text="ADD TO CART" BackColor="#86C639" Font-Bold="True" ForeColor="White" Height="30px" Width="200px" style="border: none;" OnClick="Button1_Click1" /></div>
            </div>
          </div>
        </div>
        <div class="row">
