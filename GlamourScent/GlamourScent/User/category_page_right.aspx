<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="category_page_right.aspx.cs" Inherits="GlamourScent.User.category_page_right" %>
      ...
      <div id="column-right" class="col-sm-4 col-md-4 col-lg-3 ">
        <div class="left-sidebar-widget">
          ...
          <div class="filter mb_50">
            <div class="heading-part">
              <h2 class="sub_title pull-left">Refinr Search</h2>
            </div>
